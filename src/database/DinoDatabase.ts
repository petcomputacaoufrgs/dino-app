...
class DinoDatabase extends Dexie {
    ...
    constructor() {
        ...
        this.version(DATABASE_VERSION).stores({
          note: '++id,external_id,order,question,answer,tagNames,lastUpdate,lastOrderUpdate,savedOnServer,columnTitle',
          deletedNote: '++id,external_id,order,question,answer,tagNames,lastUpdate,lastOrderUpdate,savedOnServer,columnTitle',
