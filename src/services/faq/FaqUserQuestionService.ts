...
import FaqUserQuestionRepository, { FaqUserQuestionRepositoryImpl } from '../../storage/database/faq/FaqUserQuestionRepository'
...
> {
 async convertModelToEntity(model: FaqUserQuestionDataModel): Promise<FaqUserQuestionEntity | undefined> {
  ...
  async convertEntityToModel(entity: FaqUserQuestionEntity): Promise<FaqUserQuestionDataModel | undefined> {
