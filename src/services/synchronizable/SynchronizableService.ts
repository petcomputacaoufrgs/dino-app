...
export default abstract class SynchronizableService<
    ...
    protected syncProcessGenericResponse = (response: SynchronizableGenericResponseModel | undefined): boolean => {
        if (response) {
            if (response.success) {
                return true
            }
    ...
    protected apiGet = async (id: ID): Promise<SynchronizableDataResponseModel<ID, DATA_MODEL> | undefined> =>  {
    ...
    protected apiSave = async (data: DATA_MODEL): Promise<SynchronizableDataResponseModel<ID, DATA_MODEL> | undefined> => {
    ...
    protected apiDelete = async (model: DATA_MODEL): Promise<SynchronizableDataResponseModel<ID, DATA_MODEL> | undefined> => {
    ...
    protected apiGetAll = async (): Promise<SynchronizableListDataResponseModel<ID, DATA_MODEL> | undefined> => {
    ...
    protected apiSaveAll = async (models: DATA_MODEL[]): Promise<SynchronizableGenericResponseModel | undefined> => {
    ...
    protected apiDeleteAll = async (models: DATA_MODEL[]): Promise<SynchronizableGenericResponseModel | undefined> => {
