export default interface LanguageBase {
  ...
  NOTE_COLUMN_CANT_DELETE_DIALOG_QUESTION: string
  NOTE_COLUMN_DELETE_DIALOG_DESC: string
  NOTE_COLUMN_CANT_DELETE_DIALOG_DESC: string
  NOTE_COLUMN_DELETE_DIALOG_AGREE_TEXT: string
  NOTE_COLUMN_CANT_DELETE_DIALOG_AGREE_TEXT: string
  NOTE_COLUMN_ADD_NOTE_TEXT: string
  NOTE_COLUMN_NOTE_DIALOG_TITLE: string
}
