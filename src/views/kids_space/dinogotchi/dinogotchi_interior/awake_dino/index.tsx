...
const AwakeDino: React.FC<AwakeDinoProps> = ({hat, state, handleGoSleep, handleBackgroundChange}) => {
    ...
    return (
        <>
            <Dino className={`dinogotchi_screen__dino_pet has_${hat}`} id='dino_pet'/>
            <HeartsSVG className='dinogotchi_screen__hearts' id='dinogotchi_screen__hearts'/>
