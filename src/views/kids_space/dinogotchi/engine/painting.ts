...
async function rotatePaiting(paiting: HTMLElement, degrees: number, delay: number) {
...
function isBiggerThanNegativeMax(maxDegree: number, currentDegree: number): boolean {
