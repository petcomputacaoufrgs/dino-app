...
const ContactFormDialogContent = (props: ContactFormDialogContentProps): JSX.Element => {
    ...
    const isTheInvalidNumber = (number: string): boolean => props.values.helperText.number === number
        ...
        <>
            ...
            {props.values.phones.map((phone, index) => (
                ...
                <PhoneFields
                    ...
                    helperText={isTheInvalidNumber(phone.number) ? props.values.helperText.text : ''}
