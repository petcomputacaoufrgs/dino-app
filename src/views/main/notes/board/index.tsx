...
const NoteBoard = (props: {
    onSaveQuestion: (question: string, tags: string[], noteView: NoteViewModel) => void,
    ...
    const agreementDialogProps: AgreementDialogProps = {
        onAgree: () => idNoteToDelete !== undefined && props.onDeleteNote(idNoteToDelete),
    ...
    const handleCardMove = (card, source, destination) => {
        const newBoard: NoteBoardViewModel = moveCard(props.board, source, destination)
