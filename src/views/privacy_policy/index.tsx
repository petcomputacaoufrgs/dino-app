...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="privacy_policy">
      ...
      <p>
        Armazenamos textos que você digita e salva nos nossos serviços em nuvem
        com o objetivo de disponibilizá-los para você em diferentes dispositivos
        mediante o acesso utilizando sua conta de usuário, assim você não
        precisa de preocupar caso perca acesso ao dispositivo onde você salvou
        suas informações pelos nossos serviços.
      </p>
      <p>
        Fornecemos as informações pertencentes a um usuário autenticado apenas
      ...
      <p>
        ...
        usuário. Para acesso com a conta do Google são utilizados cookies
        disponibilizados pela Google e que estão sujeitos às políticas de
      ...
      <p>
        ...
        otimizados e analisar falhas dependentes de dispositivos. Também
        armazenamos relatórios de erros para aprimorar nosso produto e oferecer
        uma melhor experiência.
      </p>
      <p>
        As informações são coletadas apenas a partir do momento que você acessa
      ...
      <p>
        ...
        automaticamente em nuvem, salvar relatórios de erros para correções
        futuras até armazenar informações disponibilizadas pelo usuário como
      ...
      <p>
        ...
        assim como as outras informações armazenamos esses dados em nuvem para
      ...
      <p>
        ...
        serviços. Esta funcionalidade é liberada mediante a sua autorização em
      ...
      <p>
        ...
        conectar um dispositivo, após salvar dados enquanto desconectado da
        internet, nossos algoritmos comparam as informações mais atualizadas em
        nuvem com suas informações locais e, em caso de conflitos, optam por
      ...
      <p>
        ...
        removidas de nossos serviços em nuvem. Caso o usuário opte pela exclusão
      ...
      <p>
        ...
        compartilhados, os conteúdos pertencem a todos os usuário de forma
      ...
      <ul>
        ...
        <li>
          Detectar, impedir ou lidar de alguma forma com fraudes, problemas
          técnicos ou de segurança;
        </li>
        <li>
          Proteger de prejuízos aos direitos, à propriedade ou à segurança do
          DinoApp, dos nossos usuários ou do público, conforme solicitado ou
          permitido por lei.
        </li>
      </ul>
      ...
      <p>
        ...
        primeiro lugar e pensamos nisto em cada nova funcionalidade ou melhoria
        dos nossos serviços. Em casos de acesso às informações necessários para
        o desenvolvimento e melhoria dos nossos serviços, possuímos rígidas
      ...
      <p>
        ...
        serviços prestados também estão restringidos pelas políticas da empresa
        hospedadora. Caso queira, o usuário poderá pedir informações sobre a(s)
      ...
      <p>
        Esta política não se aplica a serviços externos utilizados pelo DinoApp,
        como a autenticação com a conta do Google. Nestes casos se aplicam as
      ...
      <p>
        ...
        outros casos. Sempre tentaremos lhe manter a par de atualizações.
      </p>
      <p>
        Todas as versões desta política possuem uma data de início informada e
      ...
      <p>
        ...
        serviços podem ser alterados, e, em caso de alteração, tentaremos
        contactar os usuários pelos meios cabíveis.
      </p>
    </div>
  )
}
