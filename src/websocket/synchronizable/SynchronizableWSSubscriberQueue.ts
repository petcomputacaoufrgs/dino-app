...
type SynchronizableWSGenericCallBackFunction = (model: SynchronizableWSGenericModel<any>) => Promise<void>
...
class SynchronizableWSSubscriberQueue {
    ...
    addItem(callback: SynchronizableWSGenericCallBackFunction, model: SynchronizableWSGenericModel<any>) {
